...
- **Verified:** Generates concise, actionable reads (e.g. "Revenue is up 12% WoW; Havana staffing is tight Friday evenings — text your closer.")
...
- **Scope:** "Havana returns 37% on capital vs a typical Ohio smoke shop at 28% — your staffing and hourly labor are tighter."
...
- **Current:** "Havana is down 22% today" appears in Brief and insights; rule engine provides a reason ("staffing looks light")
...
- **Claude enhancement:** "Based on your peer percentile (55th) and Havana's current model, a 1% margin increase → 41% ROIC, moving you to 68th percentile. Consider pricing power in your market."
